<template>
  <el-container class="my-container">
    <el-aside width="200px" class="my-aside">
      <!-- 顶部logo -->
      <div class="my-warp">
        <!-- base64  可以减少对服务器请求图片次数 字符代表一张图片了 
         小图建议base64  大图不建议  下载太大 代码长度太长
        -->
        <img
      ...
      >
        ...
        <!-- 导航 内容管理 -->
        <el-submenu index="2" style="width:190px">
          <template slot="title">
            <i class="el-icon-location"></i>
            <span>内容管理</span>
          </template>
          <el-menu-item index="/content">发布文章</el-menu-item>
        ...
        <!-- 导航 粉丝管理 -->
        <el-submenu index="3" style="width:190px">
          <template slot="title">
        ...
        <!-- 账号信息 -->
        <el-menu-item index="/account" style="width:190px">
